...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=Path("concord-demo/data/event-localization-v1.json"))
    parser.add_argument("--media", type=Path, default=Path("concord-demo/media/soap-bubble-candidate-v1.mp4"))
